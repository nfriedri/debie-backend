...
def evaluate_svm(space, lower, uploaded, t1, t2):
    ...
    augments1_list = augmentation_retrieval.retrieve_multiple_augmentations(t1_list)
    augments2_list = augmentation_retrieval.retrieve_multiple_augmentations(t2_list)
    aug1, aug2 = specification_controller.get_vectors_for_augments(space, lower, uploaded, augments1_list, augments2_list)
...
def evaluate_simlex(space, uploaded):
    vocab, vecs = data_controller.return_vocab_vecs(space, uploaded)
